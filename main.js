...
$(window).on("load", function () {
  ...
  setTimeout(function () {
    ...
    $(document).find("img").hasClass("svg-convert") &&
      $(".svg-convert").svgConvert({ onComplete: function () {} }),
    $(document).find("div").hasClass("video-wrapper") &&
      setTimeout(function () {
        $("#video").html(
          '<video loop playsinline autoplay muted><source src="./video/6.6.mp4" type="video/mp4"></video>'
        );
      });
}),
  $(document).ready(function () {
    if (
      ...
      var e = new Swiper(".services-thumb-slider", {
        slidesPerView: 5,
        speed: 400,
        direction: "vertical",
        centeredSlides: !0,
    ...
    if (sw > 767 && $(document).find("div").hasClass("services-slider")) {
      var s = new Swiper(".services-slider", {
        slidesPerView: 1,
        initialSlide: "2",
        speed: 400,
        centeredSlides: !0,
    ...
    if (
      ...
      $(document).find("div").hasClass("worth-read__Slider") &&
        new Swiper(".worth-read__Slider", {
          ...
          breakpoints: {
            576: { slidesPerView: 2, spaceBetween: 80, centeredSlides: !0 },
            992: { slidesPerView: 3, spaceBetween: 80, centeredSlides: !1 },
      ...
      sw < 576 &&
        $(document).find("div").hasClass("serviceHelp__slider") &&
        new Swiper(".serviceHelp__slider", {
          slidesPerView: 1,
          spaceBetween: 5,
          loop: !1,
          speed: 2e3,
      ...
      var i = new Swiper(".serviceDevelopment__thumb", {
        slidesPerView: 1,
        loop: !1,
        speed: 1200,
        spaceBetween: 30,
    ...
    $(document).find("div").hasClass("serviceDevelopment__gallery") &&
      ...
      $(document).find("div").hasClass("servicesBrandsSlider") &&
        new Swiper(".servicesBrandsSlider", {
          ...
          breakpoints: {
            576: { spaceBetween: 0, slidesPerView: 3 },
            768: { slidesPerView: 4 },
            1100: { slidesPerView: 5, spaceBetween: 0 },
          },
        }),
        ...
        new Swiper(".research-design__slider", {
          ...
          autoplay:
            window.innerWidth >= 768
              ...
              : false, // Disable autoplay on devices with width less than 768 pixels
          breakpoints: {
            576: { spaceBetween: 0, slidesPerView: 3 },
            768: { slidesPerView: 3 },
            1100: { slidesPerView: 5, spaceBetween: 0 },
  ...
  $(".inner-menu-toggleBtn, .inner-menu__item--link").on("click", function () {
    ...
    $(this).hasClass("active")
      ...
      : ($(".inner-menu-toggleBtn, .inner-menu__item--link").removeClass(
          "active"
        ),
        $(".sub-inner-menu").slideUp(),
        $(this).addClass("active"),
  ...
  $(window).on("resize orientation", function () {
    (sw = $(window).width()),
      (sh = $(window).height()) < 450 && sw > 480 && sw < 820
  ...
  $(".moreless-button").click(function () {
    $(".moretext").toggleClass("active"),
      "Read more" == $(this).children("span").text()
  ...
  $(document).ready(function () {
    (function e() {
      ...
      $(".js-trigger-video-modal").on("click", function (e) {
        ...
        $("#youtube").attr(
          "src",
          "//www.youtube.com/embed/" + s + "?autoplay=1&rel=0"
        ),
        ...
        filterjson($(this).attr("data-menu")),
          ...
          sw > 767
            ...
            : ($(this).addClass("active"),
              ...
              $(".case-studies__tabs-wrapper li")
                .first()
                .addClass("mob-first-active"),
              $(this).hasClass("active") &&
      ...
      s.forEach((e) => {
        ...
        setInterval(() => {
          ...
          n.forEach(function (e) {
            console.log("======", e),
              (e.style.strokeDashoffset = 503 - 503 * (i / 100));
          });
      });
    });
  });
...
function toggleAccordion(e) {
  ...
  if (s.style.height && "0px" !== s.style.height)
    (s.style.height = "0"),
      (i.innerHTML = '<i class="fa-solid fa-angle-down"></i>');
  else {
    let t = s.querySelector(".content-inner");
    (s.style.height = t.offsetHeight + "px"),
      (i.innerHTML = '<i class="fa-solid fa-angle-up"></i>');
  }
}
$(document).ready(function () {
  $(window).scroll(function () {
    $(window).scrollTop() > 100
      ? $("#animatedButton").addClass("get-in-touch-wrap-r")
      : $("#animatedButton").removeClass("get-in-touch-wrap-r");
  });
}),
  $(document).ready(function () {
    var e = $(".addressSwitch"),
...
form.addEventListener("submit", async function (e) {
  ...
  try {
    ...
    // Once successful, redirect to the next page immediately
